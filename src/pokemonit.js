      ...
      <div className='pokemon-wrap'>
        <div className='pokemon-card'>
          ...
          <div className="hoverwrap">
            ...
            {isToggled ? <img onClick={() => setIsToggled(!isToggled)} id="back" width="200px" height="200px" src={pokemoni.sprites.back_default ? pokemoni.sprites.back_default : notfound}></img> : 
            <img onClick={() => setIsToggled(!isToggled)} id="front" width="200px" height="200px" src={pokemoni.sprites.front_default ? pokemoni.sprites.front_default : notfound}></img>}
